...
CGame.execOnModuleLoad(function()
    ...
    loadingUI.renderUI = function()
        ...
        local cDownloaded, cBandwidth, cProgress, cETA = imports.assetify.getDownloadProgress()
