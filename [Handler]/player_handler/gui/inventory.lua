        ...
        elseif renderData.renderType == "preRender" then
            ...
            if inventoryUI.vicinityInventory.element and inventoryUI.buffer[(inventoryUI.vicinityInventory.element)] then
                ...
                for i = 1, #vicinity_bufferCache, 1 do
                    ...
                    if itemValue > 0 then
                        imports.beautify.native.drawImage(j.startX, j.offsetY + j.startY, j.width, j.height, CInventory.CItems[(j.item)].inventory.icon, 0, 0, 0, -1, false)
                    end
            ...
            if inventoryUI.attachedItem then
                ...
                imports.beautify.native.drawImage(attachment_posX, attachment_posY, inventoryUI.attachedItem.__width, inventoryUI.attachedItem.__height, CInventory.CItems[(inventoryUI.attachedItem.item)].inventory.icon, 0, 0, 0, -1, false)
