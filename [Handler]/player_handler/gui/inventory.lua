...
CGame.execOnModuleLoad(function()
    ...
    inventoryUI.addItem = function()
        ...
        imports.triggerServerEvent("Player:onAddItem", inventoryUI.attachedItem.parent, inventoryUI.attachedItem.item, inventoryUI.attachedItem.parent, inventoryUI.attachedItem.prevSlot, inventoryUI.attachedItem.isPlaceable.slot)
        return true
    end
