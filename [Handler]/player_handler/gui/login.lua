    ...
    loginUI.phases[2].manageCharacter = function(action)
        ...
        elseif action == "save" then
            if (#loginUI.characters > 0) and loginUI.characters[(loginUI.previewCharacter)].id then
                ...
                imports.assetify.network:emit("Player:onSaveCharacter", true, false, localPlayer, loginUI.previewCharacter, loginUI.characters)
            end
    ...
    loginUI.phases[2].toggleUI = function(state)
        if state then
            ...
            imports.beautify.render.create(function()
                ...
                imports.beautify.native.drawText(loginUI.phases[2].titlebar.title, 0, 0, loginUI.phases[2].width, loginUI.phases[2].titlebar.height, loginUI.phases[2].titlebar.fontColor, 1, loginUI.phases[2].titlebar.font.instance, "center", "center", true, false, false)
                ...
                for i = 1, #loginUI.phases[2].categories, 1 do
                    ...
                    imports.beautify.native.drawText(j.title, 0, j.offsetY, loginUI.phases[2].width, category_offsetY, loginUI.phases[2].categories.fontColor, 1, loginUI.phases[2].categories.font.instance, "center", "center", true, false, false)
            ...
            elseif loginUI.phase == 2 then
                ...
                for i = 1, #loginUI.phases[2].options, 1 do
                    ...
                    if isToolTipVisible then
                        ...
                        imports.beautify.native.drawText(j.tooltip.text, tooltip_offsetX, j.startY, tooltip_offsetX + tooltip_width, j.startY + loginUI.phases[2].options.size, loginUI.phases[2].options.tooltipFontColor, 1, loginUI.phases[2].options.tooltipFont.instance, "center", "center", true)
                    end
                end
