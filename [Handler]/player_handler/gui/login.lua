    ...
    phases = {
        ...
        [2] = {
            ...
            options = {
                ...
                {
                    bgTexture = imports.beautify.native.createTexture("files/images/login/character/create.png", "dxt5", true, "clamp"),
                    exec = function() manageCharacter("create") end
                },
                {
                    bgTexture = imports.beautify.native.createTexture("files/images/login/character/delete.png", "dxt5", true, "clamp"),
    ...
    elseif renderData.renderType == "render" then
        ...
        if loginUI.phase == 1 then
            ...
            for i = 1, #loginUI.phases[1].optionsUI, 1 do
                ...
                imports.beautify.native.drawRectangle(options_offsetX + ((option_width - (option_width*j.animAlphaPercent))*0.5), options_offsetY + option_height, option_width*j.animAlphaPercent, FRAMEWORK_CONFIGS["UI"]["Login"]["Options"].play.embedLineSize, imports.tocolor(unpackColor(FRAMEWORK_CONFIGS["UI"]["Login"]["Options"].play.embedLineColor)), false)
            end
