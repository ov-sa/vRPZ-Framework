        ...
        elseif loginUI.phase == 2 then
            ...
            for i = 1, #loginUI.phases[2].options, 1 do
                ...
                if (j.tooltip.animPercent > 0) then
                    ...
                    imports.beautify.native.drawText(j.tooltip.identifier[FRAMEWORK_LANGUAGE], loginUI.phases[2].options.startX + loginUI.phases[2].options.size + 5, j.startY, loginUI.phases[2].options.startX + loginUI.phases[2].options.size + 5 + j.tooltip.animPercent, j.startY + loginUI.phases[2].options.size, -1, 1, loginUI.phases[2].options.tooltipFont, "center", "center", true)
                end
            end
