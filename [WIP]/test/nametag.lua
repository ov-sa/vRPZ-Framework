...
assetify.scheduler.execOnModuleLoad(function()
    assetify.loadModule("vRPZ_Config", {"shared", "client"})
    assetify.loadModule("vRPZ_Core", {"shared", "client"})
    assetify.scheduler.boot()
end)
...
imports.beautify.render.create(nametagUI.renderUI)