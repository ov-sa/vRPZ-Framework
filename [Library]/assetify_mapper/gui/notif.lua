    ...
    for i = 1, #mapper.ui.notif.buffer, 1 do
        ...
        if j then
            ...
            if j.slideStatus == "forward" then
                ...
                notifAlphaPercent = imports.interpolateBetween(0, 0, 0, 1, 0, 0, imports.getInterpolationProgress(j.tickCounter, mapper.ui.notif.slideInDuration), "OutQuad")
                ...
                notifAlphaPercent = imports.interpolateBetween(1, 0, 0, 0, 0, 0, imports.getInterpolationProgress(j.tickCounter, mapper.ui.notif.slideOutDuration), "OutQuad")
            end
