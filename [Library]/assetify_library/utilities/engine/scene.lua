...
if localPlayer then
    ...
    function scene.public:load(cAsset, sceneManifest, sceneData)
        ...
        self.cStreamerInstance = imports.createObject(cAsset.synced.modelID, posX, posY, posZ, rotX, rotY, rotZ, (sceneManifest.enableLODs and not cAsset.synced.lodID and cAsset.synced.collisionID and true) or false)
