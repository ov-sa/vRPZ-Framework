...
configVars["Inventory"]["Items"] = {
    ...
    ["Primary"] = {
        ...
        ["m60"] = {name = "M60", weight = {rows = 2, columns = 6}, itemObjectID = 2827, itemPickupDetails = {scale = 1, rotX = 90}, weapon = {id = 34, ammo = "sniper_ammo", mag = 5, damage = 13000, fireDelay = 1500}},
        ["norinco_type_56"] = {name = "Norinco Type 56", weight = {rows = 2, columns = 6}, itemObjectID = 2827, itemPickupDetails = {scale = 1, rotX = 90}, weapon = {id = 34, ammo = "sniper_ammo", mag = 5, damage = 13000, fireDelay = 1500}},
        ["remington_700"] = {name = "Remington 700", weight = {rows = 2, columns = 6}, itemObjectID = 2827, itemPickupDetails = {scale = 1, rotX = 90}, weapon = {id = 34, ammo = "sniper_ammo", mag = 5, damage = 13000, fireDelay = 1500}},
        ["mp5"] = {name = "MP5", weight = {rows = 2, columns = 6}, itemObjectID = 2827, itemPickupDetails = {scale = 1, rotX = 90}, weapon = {id = 34, ammo = "sniper_ammo", mag = 5, damage = 13000, fireDelay = 1500}}
    },
